...
public class BigQueryIO {
  ...
  public abstract static class Write<T> extends PTransform<PCollection<T>, WriteResult> {
    ...
    /**
     * Performs streaming insert without insert id. Insert id is used to offer best effort insert deduplication.
     * Default is false, which always inserts with insert id.
     */
    public Write<T> ignoreInsertIds() { return toBuilder().setIgnoreInsertIds(true).build(); }
